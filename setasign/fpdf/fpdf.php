...
function SetFont($family, $style='', $size=0)
{
	...
	if ($fontkey == 'overpass-regulari') {
		$fontkey = 'overpass-regularI';
	} else if ($fontkey == 'overpass-boldi') {
        $fontkey = 'overpass-boldI';
	} else if ($fontkey == 'overpass-extraboldi') {
        $fontkey = 'overpass-extraboldI';
    }
	if(!isset($this->fonts[$fontkey]))
	{
